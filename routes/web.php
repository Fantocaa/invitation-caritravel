...
Route::get('/cahayamercusuar/invitation', function () {
    return Inertia::render('Invitation/No Name/CMI/page');
});
Route::get('/caritravel/invitation', function () {
    return Inertia::render('Invitation/No Name/Cari Travel/page');
});
